<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-button size="mini" class="filter-item" style="margin-left: 10px;" type="primary" icon="el-icon-plus" @click="handleCreate" v-permission="['C040102']">新增</el-button>
    </div>
    ...
    <el-table :key="tableKey" v-loading="listLoading" :data="tableData" border fit highlight-current-row style="width: 100%;">
      ...
      <el-table-column label="操作" align="center">
        <template slot-scope="{row}">
          <el-button type="primary" size="mini" @click="toModify(row)" v-permission="['C040103']">编辑</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog :title="dialogStatus=='update'?'修改用户':'添加用户'" :visible.sync="dialogFormVisible" width="500px">
