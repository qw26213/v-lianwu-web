<template>
  <div class="app-container">
    <div class="filter-container">
      <el-button size="mini" class="filter-item" style="margin-left: 10px;" type="primary" icon="el-icon-plus" @click="handleCreate" v-permission="['C040202']">新增权限</el-button>
    </div>
    <el-table :key="tableKey" v-loading="listLoading" :data="tableData" border fit highlight-current-row style="width: 100%;">
      ...
      <el-table-column label="操作" align="center" v-permission="['C040201','C040203']">
        <template slot-scope="{row}">
